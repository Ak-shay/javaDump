 ...
 *  Volatile has relation with thread safety (not thread safe)
 */
...
class SharedResource2 {
	AtomicInteger counter; // uses CAS compare and swap (kind of optimistic concurrency)
...
public class AtomicOperation {
	public static void main(String args[]) {
		...
		System.out.println(r2.get()); // 20000 answer
	}
}
